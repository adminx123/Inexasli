...
// List of statuses with dependants
const statusesWithDependants = [
    ...
    'married_or_civil_partnership_with_disabled_dependants',
    'married_or_de_facto_with_dependants',
    'married_or_de_facto_with_disabled_dependants',
    'coupled_with_dependants',
    'coupled_with_disabled_dependants'
];

// List of single statuses
...
// Function to update dependantornot visibility
export function updateDependantVisibility() {
...
// Function to update singleornot visibility
export function updateSingleOrNotVisibility() {
    const selectedFilingStatus = getLocal('fillingStatus');
...
document.addEventListener('DOMContentLoaded', () => {
    ...
    // Initial calculations and visibility updates
