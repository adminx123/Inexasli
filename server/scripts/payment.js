...
document.addEventListener("DOMContentLoaded", () => {
    ...
    payForm.addEventListener("submit", async (e) => {
      ...
      const planSelect = document.querySelector("#plan"); // New: Plan selector
      ...
      const plan = planSelect.value; // New: Get selected plan
      ...
      planSelect.disabled = true; // New: Disable plan selector
      payButton.disabled = true;
  
      const payload = { task: "pay", client_email: email, client_name: name, plan: plan }; // New: Include plan
      ...
      try {
        ...
        if (data.id) {
          ...
          planSelect.disabled = false; // New: Re-enable plan selector
