document.addEventListener("DOMContentLoaded", () => {
    // Inject HTML - modified to nest submenus inside their parent menu items
    const menuHTML = `
...
<div class="tray-menu-item-container">
    ...
    style.textContent = `
      ...
      .tray-menu-item-container {
        position: relative; /* Container for each menu item and its submenu */
        display: flex;
        flex-direction: column;
        align-items: center;
      }
      ...
      .tray-submenu {
        display: none;
        position: absolute;
        bottom: calc(100% + 5px); /* Position directly above its parent menu item */
        left: 50%;
