...
export const MODULE_VALIDATION_RULES = {
  ...
  income: {
    ...
    'income-salary-wages': { type: 'number', required: false, min: 0, max: 1000000000 },
    'income-tips': { type: 'number', required: false, min: 0, max: 1000000000 },
    'income-bonuses': { type: 'number', required: false, min: 0, max: 1000000000 },
    'income-sole-prop': { type: 'number', required: false, min: 0, max: 1000000000 },
    'income-federal-pension': { type: 'number', required: false, min: 0, max: 1000000000 },
    'income-provincial-pension': { type: 'number', required: false, min: 0, max: 1000000000 },
    'income-private-pension': { type: 'number', required: false, min: 0, max: 1000000000 },
    'income-old-age-security': { type: 'number', required: false, min: 0, max: 1000000000 },
    'income-employment-insurance': { type: 'number', required: false, min: 0, max: 1000000000 },
    'income-social-security': { type: 'number', required: false, min: 0, max: 1000000000 },
    'income-investment-property': { type: 'number', required: false, min: 0, max: 1000000000 },
    'income-capital-gains-losses': { type: 'number', required: false, min: -1000000000, max: 1000000000 },
    'income-venture-capital': { type: 'number', required: false, min: 0, max: 1000000000 },
    'income-public-dividend': { type: 'number', required: false, min: 0, max: 1000000000 },
    'income-owner-dividend': { type: 'number', required: false, min: 0, max: 1000000000 },
    'income-interest': { type: 'number', required: false, min: 0, max: 1000000000 },
    'income-royalties': { type: 'number', required: false, min: 0, max: 1000000000 },
    'income-peer-to-peer-lending': { type: 'number', required: false, min: 0, max: 1000000000 },
    'income-trust': { type: 'number', required: false, min: 0, max: 1000000000 },
    'income-alimony': { type: 'number', required: false, min: 0, max: 1000000000 },
    'income-scholarships-grants': { type: 'number', required: false, min: 0, max: 1000000000 },
    'income-tax-free-income': { type: 'number', required: false, min: 0, max: 1000000000 },
    'income-gambling-winnings': { type: 'number', required: false, min: 0, max: 1000000000 },
